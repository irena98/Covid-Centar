...
\begin{itemize}
\item \textbf{Kratak opis:} \v{C}lan medicinskog osoblja sakupljene podatke o vakcinaciji i testiranju svih korisnika prosle\dj{}uje spolja\v{s}njem zdravstvenom sistemu  koji dalje rukuje  podacima.
\item \textbf{Učesnici:}
\begin{itemize}
...
\end{itemize}
 ...
 \begin{enumerate}
   ...
   \item Sistem prikazuje stranicu sa praznim poljem za unos identifikacionog broja zahteva.
    ...
    \item Sistem \v{c}lanu medicinskog osoblja prikazuje stranicu sa informacijama o podnetom zahtevu ( informacije o vremenu podnetog zahteva, zatra\v{z}enim zalihama)
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.65]{Dijagram_komponenti_NOVI1}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{Dijagram_isporucivanjaNOVI}
