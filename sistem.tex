...
\end{itemize}
 ...
 \begin{enumerate}
	...
	\end{itemize}
    \item \v{C}lan medincskog osoblja popunjava prazno polje mejl adresom.
 ...
 \item \textbf{Alternativni tokovi:}
 \begin{itemize}
            \item[A1.] \textbf{Unos neispravne mejl adrese.} Ukoliko u koraku 4 osnovnog toka sistem utvrdi da uneta mejl adresa ne pripada  licu iz spoljnog zdravstvenog sistema koje je nadle\v{z}no za prihvatanje statistike, u\v{c}esnik o tome biva obave\v{s}ten i proces se nastavlja u koraku 3 osnovnog toka.
        \end{itemize}
\end{itemize}
...
Klasa podataka Prosl\dj{}ivanje podataka je centralna klasa podataka za eksternu razmenu podataka. Kroz nju na\v{s} sistem realizuje funkcionalnost  prosle\dj{}ivanja podataka spoljnom nadle\v{z}nom  zdravstvenom sistemu.
\\~\\
