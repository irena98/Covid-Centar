...
\end{itemize}
 ...
 \begin{enumerate}
    ...
    \begin{itemize}
                    ...
                    \item Dohvatanje statistike o broju testiranih na COVID-19 u odre\dj{}enom vremenskom periodu i odre\dj{}noj lokaciji.
                    \item Dohvatanje statistike o broju osoba sa pozitivnim testom na \newline COVID-19 u odre\dj{}enom vremenskom periodu i odre\dj{}noj lokaciji.
                    \item Dohvatanje podataka o simpotmima i tegobama na koje su ukazali pacijenti koji su koristili Kol centar u odre\d{}enom vremenskom periodu.
                    \item Dohvatanje informacija (vreme, identitet lica iz kovid ambulante, identitet lica iz ministarstva zdravlja, koli\v{c}ina zahtevanih zaliha vakcina i testova, odgovor nadle\v{z}nog lica iz ministarstva na zahtev) o potra\v{z}ivanjima novih zaliha vakcina  i testova. 
                    \item Dohvatanje informacija (vreme, identitet lica iz ministarstva) o prethodnim potra\v{z}ivanjima statistike iz ministarstva zdravlja.
                \end{itemize}
...
\subsubsection{Slučaj upotrebe: Testiranje}
...
\begin{itemize}
    ...
    \item \textbf{Osnovni tok:}
        \begin{enumerate}
           ...
           \item Nakon čekanja rezultata, radnik šalje osobi rezultate testa.
           \item Radnik ažurira bazu podataka.
        \end{enumerate}
    \item \textbf{Specijalni zahtevi:}
        \begin{itemize}
