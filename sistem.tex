...
\subsubsection{Slučaj upotrebe: Evidentiranje vakcinacije}
\begin{itemize}
    \item \textbf{Kratak opis:} Osoba je primila određenu dozu vakcine što se evidentira u sistemu od strane medicinskog radnika.
    \item \textbf{Učesnici:}
        \begin{itemize}
            \item Osoba - osoba koja se vakciniše.
	    	\item Medicinski radnik - vrši evidentiranje u sistem.
        \end{itemize}
    \item \textbf{Preduslovi:} Sistem je aktivan. Osoba je izrazila zainteresovanost za primanje vakcine.
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Sistem predla\v{z}e vreme i mesto vakcinacije narednom dozom vakcine.
