...
\subsection{Obaveštavanje o drugoj i narednim dozama vakcine}
\subsubsection{Slučaj upotrebe: Obave\v{s}tavanje o drugoj i narednim dozama vakcine}
\begin{itemize}
    \item \textbf{Kratak opis:} Sistem na osnovu podataka o primljenim vakcinama vakcinisanoj osobi \v{s}alje obave\v{s}tenje o primanju druge doze (mesec dana nakon primanja prve) i svake naredne doze (6 meseci nakon primanja prethodne).
    \item \textbf{Učesnici:} 
        \begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Sistem predla\v{z}e vreme i mesto vakcinacije.
